...
import { GtkBox, GtkFrame, GtkImage, GtkLabel, GtkScrolledWindow, GtkSwitch, ListItem, ListView } from "@gtkx/react";
                            ...
                            <GtkBox orientation={Gtk.Orientation.VERTICAL} spacing={0} marginTop={8} marginBottom={8}>
                                ...
                                >
                                    {getSettingsByCategory(category).map((setting) => (
                                        <ListItem key={setting.id} id={setting.id} value={setting} />
                                    ))}
                                </ListView>
                            </GtkBox>
                        </GtkFrame>
