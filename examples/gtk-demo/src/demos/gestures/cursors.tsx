...
import { path as aliasPath } from "#data/demos/gestures/cursors/alias_cursor.png";
import { path as allResizePath } from "#data/demos/gestures/cursors/all_resize_cursor.png";
import { path as allScrollPath } from "#data/demos/gestures/cursors/all_scroll_cursor.png";
import { path as cellPath } from "#data/demos/gestures/cursors/cell_cursor.png";
import { path as colResizePath } from "#data/demos/gestures/cursors/col_resize_cursor.png";
import { path as contextMenuPath } from "#data/demos/gestures/cursors/context_menu_cursor.png";
import { path as copyPath } from "#data/demos/gestures/cursors/copy_cursor.png";
import { path as crosshairPath } from "#data/demos/gestures/cursors/crosshair_cursor.png";
import { path as defaultPath } from "#data/demos/gestures/cursors/default_cursor.png";
import { path as dndAskPath } from "#data/demos/gestures/cursors/dnd_ask_cursor.png";
import { path as eResizePath } from "#data/demos/gestures/cursors/e_resize_cursor.png";
import { path as ewResizePath } from "#data/demos/gestures/cursors/ew_resize_cursor.png";
import { path as grabPath } from "#data/demos/gestures/cursors/grab_cursor.png";
import { path as grabbingPath } from "#data/demos/gestures/cursors/grabbing_cursor.png";
import { path as gtkLogoPath } from "#data/demos/gestures/cursors/gtk_logo_cursor.png";
import { path as helpPath } from "#data/demos/gestures/cursors/help_cursor.png";
import { path as movePath } from "#data/demos/gestures/cursors/move_cursor.png";
import { path as nResizePath } from "#data/demos/gestures/cursors/n_resize_cursor.png";
import { path as neResizePath } from "#data/demos/gestures/cursors/ne_resize_cursor.png";
import { path as neswResizePath } from "#data/demos/gestures/cursors/nesw_resize_cursor.png";
import { path as noDropPath } from "#data/demos/gestures/cursors/no_drop_cursor.png";
import { path as nonePath } from "#data/demos/gestures/cursors/none_cursor.png";
import { path as notAllowedPath } from "#data/demos/gestures/cursors/not_allowed_cursor.png";
import { path as nsResizePath } from "#data/demos/gestures/cursors/ns_resize_cursor.png";
import { path as nwResizePath } from "#data/demos/gestures/cursors/nw_resize_cursor.png";
import { path as nwseResizePath } from "#data/demos/gestures/cursors/nwse_resize_cursor.png";
import { path as pointerPath } from "#data/demos/gestures/cursors/pointer_cursor.png";
import { path as progressPath } from "#data/demos/gestures/cursors/progress_cursor.png";
import { path as rowResizePath } from "#data/demos/gestures/cursors/row_resize_cursor.png";
import { path as sResizePath } from "#data/demos/gestures/cursors/s_resize_cursor.png";
import { path as seResizePath } from "#data/demos/gestures/cursors/se_resize_cursor.png";
import { path as swResizePath } from "#data/demos/gestures/cursors/sw_resize_cursor.png";
import { path as textPath } from "#data/demos/gestures/cursors/text_cursor.png";
import { path as verticalTextPath } from "#data/demos/gestures/cursors/vertical_text_cursor.png";
import { path as wResizePath } from "#data/demos/gestures/cursors/w_resize_cursor.png";
