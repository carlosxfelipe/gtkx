...
A web browser in about 160 lines. An Adwaita window wraps a `WebKitWebView`, with back, forward, and reload/stop buttons, a URL entry in the header bar, and a progress bar that fades out when a page finishes loading. It opens [gtkx.dev](https://gtkx.dev).
