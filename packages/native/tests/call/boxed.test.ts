...
const PANGO_FONT_DESC = { type: "boxed" as const, innerType: "PangoFontDescription", lib: PANGO_LIB };
const PANGO_FONT_DESC_BORROWED = {
    type: "boxed" as const,
...
describe("call - boxed types", () => {
    describe("GdkRGBA", () => {
        ...
        it("parses RGBA from string", () => {
            ...
            const success = call(
                ...
                "gdk_rgba_parse",
                [
                    { type: RGBA_BOXED_BORROWED, value: rgba },
        ...
        it("converts RGBA to string", () => {
            ...
            const result = call(GDK_LIB, "gdk_rgba_to_string", [{ type: RGBA_BOXED_BORROWED, value: rgba }], STRING);
        ...
        it("compares two RGBA values", () => {
            ...
            const equal = call(
                ...
                "gdk_rgba_equal",
                [
                    { type: RGBA_BOXED_BORROWED, value: rgba1 },
                    { type: RGBA_BOXED_BORROWED, value: rgba2 },
                ],
                BOOLEAN,
            );
    ...
    describe("GdkRectangle", () => {
        ...
        it("checks rectangle intersection", () => {
            ...
            const intersects = call(
                ...
                [
                    { type: RECTANGLE_BOXED_BORROWED, value: rect1 },
                    { type: RECTANGLE_BOXED_BORROWED, value: rect2 },
                    { type: RECTANGLE_BOXED_BORROWED, value: dest },
                ],
                BOOLEAN,
            );
        ...
        it("checks if point is contained in rectangle", () => {
            ...
            const containsInside = call(
                ...
                [
                    { type: RECTANGLE_BOXED_BORROWED, value: rect },
                    { type: INT32, value: 50 },
                    { type: INT32, value: 50 },
                ],
                BOOLEAN,
    ...
    describe("PangoFontDescription", () => {
        it("creates font description from string", () => {
            ...
            const family = call(
                ...
                [{ type: PANGO_FONT_DESC_BORROWED, value: fontDesc }],
                STRING_BORROWED,
            );
    ...
    describe("ownership", () => {
        ...
        it("handles borrowed boxed correctly", () => {
            const rgba = alloc(16, "GdkRGBA", GDK_LIB);
            ...
            const str1 = call(GDK_LIB, "gdk_rgba_to_string", [{ type: RGBA_BOXED_BORROWED, value: rgba }], STRING);

            const str2 = call(GDK_LIB, "gdk_rgba_to_string", [{ type: RGBA_BOXED_BORROWED, value: rgba }], STRING);
