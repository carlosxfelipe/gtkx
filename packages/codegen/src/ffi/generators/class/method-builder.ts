            ...
            writer.indent(() => {
                ...
                writer.indent(() => {
                    ...
                    writer.indent(() => {
                        ...
                        writer.indent(() => {
                            writer.writeLine(
                                'type: { type: "callback", callbackType: "asyncReadyCallback", argTypes: [], returnType: { type: "undefined" }, sourceType: { type: "gobject", ownership: "borrowed" }, resultType: { type: "gobject", ownership: "borrowed" } },',
                            );
