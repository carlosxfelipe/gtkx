...
describe("userEvent", () => {
    ...
    describe("click", () => {
        ...
        it("can emit click signal on multiple buttons", async () => {
            ...
            const button1 = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Button 1" });
            const button2 = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Button 2" });
        ...
        it("can emit multiple clicks on same button", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Multi Click" });
    ...
    describe("type", () => {
        ...
        it("throws when element is not editable (button)", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Not Editable" });
    ...
    describe("activate", () => {
        it("activates a button widget", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Activate Me" });
    ...
    describe("clear", () => {
        ...
        it("throws when element is not editable (button)", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Not Clearable" });
    ...
    describe("selectOptions", () => {
        it("throws when element is not selectable", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Not Selectable" });
    ...
    describe("deselectOptions", () => {
        it("throws when element is not a ListBox", async () => {
            ...
            const button = await screen.findByRole(Gtk.AccessibleRole.BUTTON, { name: "Not a List" });
