...
import type { BoundQueries, ByRoleOptions, TextMatchOptions } from "./types.js";
...
export const within = (container: Gtk.Widget): BoundQueries => ({
    ...
    findByLabelText: (text: string | RegExp, options?: TextMatchOptions) =>
        queries.findByLabelText(container, text, options),
    findByText: (text: string | RegExp, options?: TextMatchOptions) => queries.findByText(container, text, options),
    findByTestId: (testId: string | RegExp, options?: TextMatchOptions) =>
        queries.findByTestId(container, testId, options),
    ...
    findAllByText: (text: string | RegExp, options?: TextMatchOptions) =>
        queries.findAllByText(container, text, options),
